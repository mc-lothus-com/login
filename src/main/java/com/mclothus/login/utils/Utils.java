package com.mclothus.login.utils;
...
public class Utils {
    ...
    public static void connectServer(Player player, ServerInfo serverInfo) {
        ...
        player.sendPluginMessage(AuthPlugin.getInstance(), "BungeeCord", b.toByteArray());
        return;
    }
